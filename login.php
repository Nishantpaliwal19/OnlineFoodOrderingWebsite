...
<?php
	...
	{
		$sql = "SELECT * FROM `USER` WHERE `email` = '".mysqli_real_escape_string(mysqli_connect("localhost","root","","foodies"),$_POST['email'])."' AND `pw` = '".mysqli_real_escape_string(mysqli_connect("localhost","root",""),$_POST['password'])."'";
		$sql_result = mysqli_query (mysqli_connect("localhost","root","","foodies"),$sql ) or die ('request "Could not execute SQL query" '.$sql);
